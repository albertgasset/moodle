...
final class get_configuration_test extends advanced_testcase {
    ...
    public function test_execute_with_teacher(): void {
        ...
        $plugins = [
            ...
            ['name' => 'link', 'settings' => []],
            ['name' => 'media', 'settings' => []],
            ['name' => 'premium', 'settings' => self::get_premium_settings($context)],
     ...
     * @return array
     */
    private static function get_premium_settings(\context $context): array {
        return [
            [
                'name' => 'premiumplugins',
    ...
    private static function get_recordrtc_settings(): array {
        return [
            ...
            [
                'name' => 'audiortcformat',
                'value' => (string) get_config('tiny_recordrtc', 'audiortcformat'),
            ],
        ];
    }
