...
Feature: Use the TinyMCE editor to upload an h5p package
  ...
  Scenario: Enable/disable display options
    ...
    And I click on the "Insert H5P content" button for the "Page content" TinyMCE editor
    Then "input[aria-label=\"Auto-play in the mobile app\"]:not(checked)" "css_element" should exist
    When I click on "Browse repositories..." "button" in the "Insert H5P content" "dialogue"
    And I click on "Private files" "link" in the ".fp-repo-area" "css_element"
    And I click on "guess-the-answer.h5p" "link"
    And I click on "Select this file" "button"
    ...
    And I click on "Insert H5P" "button" in the "Insert H5P content" "dialogue"
    And I click on "Save and display" "button"
    Then ".h5p-placeholder[data-mobileapp-autoplay=true]" "css_element" should exist
    When I navigate to "Settings" in current page administration
    And I select the ".h5p-placeholder" "css_element" in the "Page content" TinyMCE editor
    And I click on the "Insert H5P content" button for the "Page content" TinyMCE editor
    Then "input[aria-label=\"Auto-play in the mobile app\"]:checked" "css_element" should exist
    When I click on "Auto-play in the mobile app" "checkbox"
    And I click on "Insert H5P" "button" in the "Insert H5P content" "dialogue"
    And I wait "1" seconds
    And I click on "Save and display" "button"
    Then ".h5p-placeholder:not([data-mobileapp-autoplay=true])" "css_element" should exist
    When I navigate to "Settings" in current page administration
    And I select the ".h5p-placeholder" "css_element" in the "Page content" TinyMCE editor
    And I click on the "Insert H5P content" button for the "Page content" TinyMCE editor
    Then "input[aria-label=\"Auto-play in the mobile app\"]:not(checked)" "css_element" should exist
